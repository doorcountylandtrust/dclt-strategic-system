...
- [Change Communication Strategy](change-communication-strategy.md)
- [Audience Segmentation](audience-segmentation-messaging-strategy.md)
...
- [Messaging System](audience-segmentation-messaging-strategy/messaging-frameworks-lenses.md)
- Comms Calendar
...
- Add quote-based personas from focus groups
- Use journey maps to inform new staff onboarding materials
- Visualize with timeline or storyboard if helpful